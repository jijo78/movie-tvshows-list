  ...
  return (
    <>
      ...
      <form>
        <div>
          <label htmlFor=""></label>
          <input type="radio" name="filterTv" aria-label="primary radio" />
        </div>
        <div>
          <input type="radio" name="filterMovie" aria-label="primary radio" />
        </div>
        <div>
          <input type="radio" name="filterActor" aria-label="primary radio" />
        </div>
      </form>
