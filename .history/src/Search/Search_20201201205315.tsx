      ...
      <form>
        <select
          ...
          onChange={(e: React.ChangeEvent<any>) => {
            ...
            console.log('dataPreFiltered: ', dataPreFiltered)

            const dataFiltered = dataPreFiltered.filter((r) => r.media_type === e.target.value)
            console.log('dataPreFiltered: after', dataPreFiltered, dataFiltered)
